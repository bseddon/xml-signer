...
/**
 * Placeholder for &lt;ArchiveTimeStamp> which is not supported yet
 */
class ArchiveTimeStamp extends XAdESTimeStamp implements UnsignedSignatureProperty
{
	/**
	...
	{
		return ElementNames::ArchiveTimeStamp;
	}
}
